...
namespace Common
{
    ...
    [Serializable]
    public class creature_spawns : DataObject
    {
        ...
        public creature_spawns(Creature_proto proto, uint guid, ushort zoneId, int worldX, int worldY, int worldZ, int worldO)
        {
        ...
        public creature_spawns(Creature_proto proto, uint guid, ushort zoneId, int worldX, int worldY, int worldZ, int worldO, byte level)
        {
            BuildFromProto(proto);
            _Guid = guid;
            _ZoneId = zoneId;
        ...
        public creature_spawns(Creature_proto proto, uint guid, ushort zoneId, int worldX, int worldY, int worldZ, int worldO, byte faction, byte level)
        {
            BuildFromProto(proto);
            _Guid = guid;
            _ZoneId = zoneId;
