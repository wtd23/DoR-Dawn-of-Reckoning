...
namespace Common
{
    [DataTable(PreCache = false, TableName = "character_info_items", DatabaseName = "World", BindMethod = EBindingMethod.StaticBound)]
    [Serializable]
    public class character_info_items : DataObject
    {
