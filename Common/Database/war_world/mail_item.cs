...
namespace Common
{
    public class mail_item
    {
        ...
        public mail_item(uint id, ushort count)
        {
            this.id = id;
            this.count = count;
        }

        public mail_item(uint id, String additonalinfo, ushort count)
        {
            this.id = id;
            this.count = count;
        ...
        public mail_item(uint id, List<Talisman> talisman, ushort primary_dye, ushort secondary_dye, ushort count)
        {
            this.id = id;
            this.count = count;
