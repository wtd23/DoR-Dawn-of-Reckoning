...
namespace Common
{
    ...
    public class item_infos : DataObject
    {
        ...
        public List<KeyValuePair<item_infos, ushort>> RequiredItems = new List<KeyValuePair<item_infos, ushort>>();

        [PrimaryKey]
        public uint Entry
        { get { return _entry; } set { _entry = value; } }
        ...
        [DataElement()]
        public uint ModelId
        { get { return _modelId; } set { _modelId = value; } }

        [DataElement()]
        public ushort SlotId
        { get { return _slotId; } set { _slotId = value; } }

        [DataElement()]
        public byte Rarity
        { get { return _rarity; } set { _rarity = value; } }

        [DataElement()]
        public uint Career
        { get { return _career; } set { _career = value; } }

        [DataElement()]
        public uint Skills
        { get { return _skills; } set { _skills = value; } }

        [DataElement()]
        public byte Bind
        { get { return _bind; } set { _bind = value; } }
        ...
        { get { return _spellId; } set { _spellId = value; } }

        [DataElement()]
        public uint ItemSet
        { get { return _itemSet; } set { _itemSet = value; } }

        [DataElement()]
        public ushort Dps
        { get { return _dps; } set { _dps = value; } }
        ...
        [DataElement()]
        public byte MinRank
        { get { return _minRank; } set { _minRank = value; } }

        [DataElement()]
        public byte MinRenown
        { get { return _minRenown; } set { _minRenown = value; } }

        [DataElement()]
        public byte ObjectLevel
        { get { return _objectLevel; } set { _objectLevel = value; } }

        [DataElement()]
        public byte UniqueEquiped
        { get { return _uniqueEquiped; } set { _uniqueEquiped = value; } }

        [DataElement()]
        public int StartQuest
        { get { return _startQuest; } set { _startQuest = value; } }
        ...
        { get { return _sellPrice; } set { _sellPrice = value; } }
        ...
        [DataElement()]
        public byte TalismanSlots
        { get { return _talismanSlots; } set { _talismanSlots = value; } }

        [DataElement()]
        public ushort MaxStack
        { get { return _maxStack; } set { _maxStack = value; } }
        ...
        { get { return _scriptName; } set { _scriptName = value; } }

        [DataElement()]
        public bool TwoHanded
        { get { return _twoHanded; } set { _twoHanded = value; } }
        ...
        { get { return _craftresult; } set { _craftresult = value; } }

        [DataElement()]
        public bool DyeAble
        { get { return _dyeAble; } set { _dyeAble = value; } }

        [DataElement()]
        public bool Salvageable
        { get { return _salvageable; } set { _salvageable = value; } }

        [DataElement()]
        public ushort BaseColor1
        { get { return _baseColor1; } set { _baseColor1 = value; } }

        [DataElement()]
        public ushort BaseColor2
        { get { return _baseColor2; } set { _baseColor2 = value; } }
