...
{
    [DataTable(PreCache = false, TableName = "live_event_infos", DatabaseName = "World", BindMethod = EBindingMethod.StaticBound)]
    [Serializable]
    public class live_event_infos : DataObject
    {
        [PrimaryKey]
        ...
        public List<live_event_reward_infos> Rewards { get; set; } = new List<live_event_reward_infos>();
        public List<live_event_task_infos> Tasks { get; set; } = new List<live_event_task_infos>();
    }
}