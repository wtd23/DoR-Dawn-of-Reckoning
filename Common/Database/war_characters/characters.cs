...
namespace Common
{
    ...
    public class characters : DataObject
    {
        ...
        public List<characters_honor_reward_cooldown> HonorCooldowns { get; set; }

        public characters_value Value;

        public characters_client_data ClientData;

        public List<characters_socials> Socials;

        public List<characters_toks> Toks;

        public List<characters_toks_kills> TokKills;

        public List<characters_quests> Quests;

        public List<characters_influences> Influences;

        public List<characters_bag_pools> Bag_Pools;

        public List<characters_mails> Mails;

        public List<characters_saved_buffs> Buffs;
