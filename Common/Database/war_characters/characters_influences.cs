...
namespace Common
{
    [DataTable(PreCache = false, TableName = "characters_influences", DatabaseName = "Characters", BindMethod = EBindingMethod.StaticBound)]
    [Serializable]
    public class characters_influences : DataObject
    {
        ...
        public characters_influences()
        {
        }

        public characters_influences(int CharacterId, ushort InfluenceId, uint InfluenceCount)
        {
