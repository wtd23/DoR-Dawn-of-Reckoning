...
namespace Common
{
    ...
    public class guild_info : DataObject
    {
        ...
        public Dictionary<ushort, guild_vault_item>[] Vaults =
        {
            new Dictionary<ushort, guild_vault_item>(),
            new Dictionary<ushort, guild_vault_item>(),
            new Dictionary<ushort, guild_vault_item>(),
            new Dictionary<ushort, guild_vault_item>(),
            new Dictionary<ushort, guild_vault_item>()
        ...
        public Dictionary<uint, guild_members> Members;
        public Dictionary<byte, guild_ranks> Ranks;
        public Dictionary<byte, guild_event> Event = new Dictionary<byte, guild_event>();
        public List<guild_logs> Logs;
    }
}