...
namespace WorldServer.World.Objects.Instances.The_Lost_Vale
{
    public class SimpleSechartheDarkpromiseChieftain : InstanceBossSpawn
    {
        ...
        public SimpleSechartheDarkpromiseChieftain(creature_spawns spawn, uint bossId, ushort Instanceid, Instance instance) : base(spawn, bossId, Instanceid, instance)
        {
